      ...
      <div className={styles.cartContainer}>
        ...
        {basket?.length === 0 ? (
          <div className={styles.emptyCartSection}>
            <img
              src="/images/empty-cart.svg" // Make sure this image path is correct or use a valid one
              alt="Empty cart"
                  ...
                  <div className={styles.productDetailsArea}>
                    ...
                    <div className={styles.cartItemProductCardWrapper}>
                      <ProductCard
                        ...
                        renderDesc={true}
                        renderAdd={false}
                        flex={true} // This prop is for ProductCard's internal layout
                      />
                    </div>
                    <div className={styles.itemActions}>
                      ...
                      {/* <span className={styles.actionLink}>Compare with similar items</span> */}
                    </div>
                  </div>
