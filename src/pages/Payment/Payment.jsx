...
import styles from "./payment.module.css"; // Ensure this path is correct
...
const Payment = () => {
  ...
  const [processing, setProcessing] = useState(false); // For button state
  ...
  const handlePayment = async (e) => {
    ...
    // Early return if Stripe.js hasn't loaded or basket is empty
    ...
    <LayOut>
      <div className={styles.payment_page_container}>
        ...
        <form onSubmit={handlePayment} className={styles.payment_form_layout}>
          {/* Left Panel: Shipping, Review, Payment Method */}
          <div className={styles.payment_main_content}>
            <div className={styles.checkout_section}>
              ...
              <div className={styles.section_content}>
                <p>{user?.email}</p>
                <p>123 React Lane</p> {/* Placeholder address */}
                <p>Chicago, IL</p> {/* Placeholder address */}
              </div>
            </div>
